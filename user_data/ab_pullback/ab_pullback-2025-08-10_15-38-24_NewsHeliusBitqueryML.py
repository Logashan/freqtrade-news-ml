...
class NewsHeliusBitqueryML(IStrategy):
    ...
    entry_mode = CategoricalParameter(["breakout", "pullback"], default="pullback", space="buy", optimize=True)
    ...
    def populate_entry_trend(self, df: DataFrame, metadata: dict) -> DataFrame:
        ...
        if mode == "breakout":
            ...
            long_cond = vol_ok & (df["close"] > donch_hi)
            short_cond = vol_ok & (df["close"] < donch_lo)
        else:
